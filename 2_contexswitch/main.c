...
int main(void)
{
	...
	//init user tasks
	init_task(0, (uint32_t*)task0, user_stacks[0]+1024);//init_task(0, ??????, ??????);
	init_task(1, (uint32_t*)task1, user_stacks[1]+1024);//init_task(1, ??????, ??????);
	init_task(2, (uint32_t*)task2, user_stacks[2]+1024);//init_task(2, ??????, ??????);
